...
if (!empty($_GET['id'])) {
    ...
    echo $refresh(0, "?page=komentar_artikel");
}
...
if (isset($_POST['ubah_komentar'])) {
    ...
    mysqli_query($conn, "UPDATE komentar SET komentar ='$komentar' WHERE id_komentar='$id'");
    echo $refresh(0, "?page=komentar_artikel");
}
?>
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h3 class="h3 mb-0 text-gray-800">Komentar Artikel</h3>
</div>
        ...
        <div class="table-responsive p-2">
            <table class="table py-3" id="dataTable" style="min-width: 1000px;">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    $q = mysqli_query($conn, "SELECT a.tanggal as tanggalk, b.tanggal as tanggala , a.*, b.* FROM komentar a LEFT JOIN artikel b ON a.id_artikel=b.id_artikel WHERE a.id_user='$id_user'");
                                            ...
                                            <div class="modal-body py-3">
                                                ...
                                                <div class="card mt-4">
                                                    <div class="card-body">
                                                        ...
                                                        <?php
                                                        $a = -2;
                                                        $query_k = mysqli_query($conn, "SELECT * FROM komentar a LEFT JOIN user b ON a.id_user=b.id_user WHERE id_artikel='$data[id_artikel]'");
